...
# this is a random delay to change all dates in the document
...
# French initialisation of Faker library
fake = Faker('fr_FR')

# Library to keep new names for the whole document
...
def generate_random_mail():
    ...
    fake_mail = f"{first_name.lower()}.{last_name.lower()}@{fake.domain_name()}"
...
docpdf = fitz.open('native_pdf/RCP.pdf')  # the file with the text you want to change
